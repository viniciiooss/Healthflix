...
function Movies(props) {
  ...
  const [value, setValue] = useState("Adicionar aos favoritos");

  function Add(data) {
    var imbdid = data["imdbID"];
    var valueid = data["Título"];
      ...
      <div id="displaycard" style={{}}>
        ...
        >
          ...
          <Card.Body>
            ...
            <Card.Text>Atores: {data["Actors"]}</Card.Text>
            <Card.Text>Gênero: {data["Genre"]}</Card.Text>
            <Card.Text>{data["Year"]}</Card.Text>
            <Card.Text>Diretor: {data["Director"]}</Card.Text>
            <Card.Text>Roteiristas: {data["Writer"]}</Card.Text>
            <Card.Text>Duração: {data["Runtime"]}</Card.Text>
            <Card.Text>Idioma: {data["Language"]}</Card.Text>
            <Card.Text className={styles.imbd}>
              {" "}
              IMDb : {data["imdbRating"]}/10
            </Card.Text>
            <Card.Text>Bilheteria: {data["BoxOffice"]}</Card.Text>
          </Card.Body>
        </Card>
        <Card
          style={{
